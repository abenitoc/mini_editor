...
var getOptions = function(){
	if(!options){
		...
		configuration["SoundCloud"] = false;
		...
		///////////////////
		 configuration["ve_theme"] = {
		 	"cssPath": "http://localhost:8000/examples/VE_Theme/ve_theme.css",
		 	"callback": function(V,options,presentation){
		 		$("#presentation_details_logo").attr("src", "/images/logos/free_learn_icon.png");
